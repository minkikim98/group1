...
static void thread_update_priority (struct thread *, int);
static void thread_add_to_ready_list (struct thread *);
static void thread_update_ready_list (struct thread *);
